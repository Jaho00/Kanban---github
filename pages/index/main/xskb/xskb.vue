				...
				<view class="row col-12 no-gutters first_content">
					<view class="col-3 add_border allsize" style="max-width: 21%!important;">
						<view class="row no-gutters">
							<text style="color: #ffffff;font-size: .25rem;">月接单统计</text>
						</view>
					...
					<view class="col allsize" style="max-width: 63.3%!important;">
						<!-- <view class="row no-gutters add_border" style="height: 30%;">
							<view class="col mr-1 row no-gutters">
								<view class="col-12 row" style="color: #db3c49;height: 60%;">
									<text class="col color_text align-self-center">{{ scjy.OTD }}</text>
								</view>
								<view class="col-12 row align-items-center type_box" style="">
									<text class="col type_text">OTD</text>
								</view>
							</view>
							<view class="col mr-1 row no-gutters">
								<view class="col-12 row align-items-center" style="color: #da6d49;height: 60%;">
									<text class="col color_text">{{ scjy.CAST }}</text>
								</view>
								<view class="col-12 row align-items-center type_box">
									<text class="col type_text">铸造</text>
								</view>
							</view>
							<view class="col mr-1 row no-gutters">
								<view class="col-12 row align-items-center" style="color: #c3ab13;height: 60%;">
									<text class="col color_text">{{ scjy.BLANK }}</text>
								</view>
								<view class="col-12 row align-items-center type_box">
									<text class="col type_text">毛坯入库</text>
								</view>
							</view>
							<view class="col mr-1 row no-gutters">
								<view class="col-12 row align-items-center" style="color: #02d68a;height: 60%;">
									<text class="col color_text">{{ scjy.MADE }}</text>
								</view>
								<view class="col-12 row align-items-center type_box">
									<text class="col type_text">成品加工</text>
								</view>
							</view>
							<view class="col mr-1 row no-gutters">
								<view class="col-12 row align-items-center" style="color: #2f6cec;height: 60%;">
									<text class="col color_text">{{ scjy.PACK }}</text>
								</view>
								<view class="col-12 row align-items-center type_box">
									<text class="col type_text">成品入库</text>
								</view>
							</view>
							<view class="col mr-1 row no-gutters">
								<view class="col-12 row align-items-center" style="color: #ebe50a;height: 60%;">
									<text class="col color_text">{{ scjy.SHIP }}</text>
								</view>
								<view class="col-12 row align-items-center type_box">
									<text class="col type_text">销售出库</text>
								</view>
							</view>
						</view> -->
						<view class="row no-gutters add_border" style="height: 100%;">
							<view class="row no-gutters">
								<text style="color: #ffffff;font-size: .25rem;">每日新增订单</text>
							</view>
					...
					<view class="col-2 add_border allsize">
						...
						<view class="row no-gutters justify-content-center">
							<text style="color: #FFFFFF;font-size: .4rem;">本月合格率</text>
						</view>
					</view>
				</view>
				<view class="row col-12 no-gutters second_content justify-content-around">
					<view class="col-10" style="width: 100%;height: 50%;">
						<view class="row no-gutters allsize">
							<view class="col addpadding allsize">
								<view class="add_border allsize">
									<view class="row no-gutters">
										<text style="color: #ffffff;font-size: .25rem;">今日入库</text>
									</view>
									<view class="chart_content">
							...
							<view class="col addpadding allsize">
								<view class="allsize add_border">
									<view class="row no-gutters">
										<text style="color: #ffffff;font-size: .25rem;">月度入库</text>
									</view>
									<view class="down_charts">
										<!-- chart图表区域 -->
							...
							<view class="col addpadding allsize">
								<view class="allsize add_border">
									<view class="row no-gutters">
										<text style="color: #ffffff;font-size: .25rem;">今日出库</text>
									</view>
									<view class="down_charts">
							...
							<view class="col addpadding allsize">
								<view class="allsize add_border">
									<view class="row no-gutters">
										<text style="color: #ffffff;font-size: .25rem;">月度出库</text>
									</view>
									<view class="down_charts">
										<!-- chart图表区域 -->
						...
						<view class="row no-gutters" style="width: 100%;height: 95%;">
							<view class="row no-gutters">
								<text style="color: #ffffff;font-size: .25rem;">订单进度</text>
							</view>
										...
										<u-table class="scrollList tableHeight" style="width: 100%;" bg-color="transparent" color="#FFFFFF"
										 border-color="#052D84">
											<u-tr v-for="(item,index) in zdcp" :key="item.FCO" class="GdTrHeight">
												<u-td width="10%" style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size: .17rem;padding: 0;">
													{{ item.FCO }}
												</u-td>
												<u-td width="10%" style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size: .2rem; padding: 0;">
													{{ item.PRD_NAME }}
												</u-td>
					...
					<view class="col-2" style="height: 99%;width: 100%;">
						<view class="row no-gutters" style="height: 100%;">
							<view class="col-12" style="height: 50%;">
								<view class="allsize add_border">
									<view class="row no-gutters">
										<text style="color: #ffffff;font-size: .25rem;">月不良统计</text>
									</view>
									<view class="down_charts">
							...
							<view class="col-12" style="height: 48%;">
								<view class="allsize add_border">
									<view class="allsize">
										<view class="row no-gutters">
											<text style="color: #ffffff;font-size: .25rem;">月报废统计</text>
										</view>
										<view class="down_charts">
		...
		methods: {
			scrollGD() {
				setTimeout(() => {
					...
					// let GDlength = (_self.zdcp.length - allindex) > 0 ? (_self.zdcp.length - allindex) : 0;
			...
			showBLTJ(canvasId, chartData) {
				// let Column = {
				// 	series: [{name:'不良统计',data:[],textColor:'#ffffff'}], //纵坐标  tips:柱子数字颜色也在这设置
				// 	categories:[],  //横坐标
				// };
				...
				// setTimeout(() => {
				// 	let bltjDiv = uni.createSelectorQuery().in(this).select(".bltjDiv");
				// 	bltjDiv.fields({
				// 		size: true,
				// 		scrollOffset: true
				// 	}, data => {
				...
				// 			width: data.width
				// 		};
				// 		bltjColumn = new uCharts({
				// 			$this: _self,
				// 			canvasId: canvasId,
				// 			type: 'column',
				// 			legend:{show:false,fontColor:'#ffffff'},
				// 			fontSize:11,
				// 			background:'#FFFFFF',
				// 			pixelRatio:1,
				// 			animation: true,
				...
				// 			},
				// 			dataLabel: true,
				// 			width: _self.bltjDiv.width,
				// 			height: _self.bltjDiv.height,
				// 			extra: {
				// 				line:{
				// 					type: 'straight'
				// 				}
			...
			showBFTJ(canvasId, chartData) {
				// let Column = {
				// 	series: [{name:'订单统计',data:[],textColor:'#ffffff'}], //纵坐标  tips:柱子数字颜色也在这设置
				// 	categories:[],  //横坐标
				// };
				// if(chartData == null || chartData.length == 0){
				// 	Column.series[0].data.push(
				...
				// setTimeout(() => {
				// 	let bftjDiv = uni.createSelectorQuery().in(this).select(".bftjDiv");
				// 	bftjDiv.fields({
				// 		size: true,
				// 		scrollOffset: true
				// 	}, data => {
				...
				// 			},
				// 			dataLabel: false,
				// 			width: _self.bftjDiv.width,
				// 			height: _self.bftjDiv.height,
				// 			extra: {
				// 				line:{
				// 					type: 'straight'
				// 				}
